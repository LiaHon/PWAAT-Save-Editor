...
class FrameMain ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.m_mi_xbox_file2steam_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Xbox）→ 文件（Steam）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_xbox_file2steam_file )

        self.m_mi_steam_file2_xbox_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Steam）→ 文件（Xbox）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_steam_file2_xbox_file )

        self.m_menu_convert.AppendSeparator()

        self.m_mi_android_file2steam_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Android）→ 文件（Steam）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_android_file2steam_file )

        self.m_mi_steam_file2_android_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Steam）→ 文件（Android）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_steam_file2_android_file )

        self.m_mi_android_file2xbox_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Android）→ 文件（Xbox）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_android_file2xbox_file )

        self.m_mi_xbox_file2android_file = wx.MenuItem( self.m_menu_convert, wx.ID_ANY, _(u"文件（Xbox）→ 文件（Android）..."), wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_convert.Append( self.m_mi_xbox_file2android_file )
        ...
        self.Bind( wx.EVT_MENU, self.mi_xbox_file2steam_file_on_choice, id = self.m_mi_xbox_file2steam_file.GetId() )
        self.Bind( wx.EVT_MENU, self.mi_steam_file2_xbox_file_on_choice, id = self.m_mi_steam_file2_xbox_file.GetId() )
        self.Bind( wx.EVT_MENU, self.mi_android_file2steam_file_on_choice, id = self.m_mi_android_file2steam_file.GetId() )
        self.Bind( wx.EVT_MENU, self.mi_steam_file2_android_file_on_choice, id = self.m_mi_steam_file2_android_file.GetId() )
